#### u-boot patching: 21 total patches; 21 applied; 1 with problems; 1 needs_rebase
...
| ⚠️`[needs_rebase]`  | `general-rk3588-raise-cpu-clocks-via-scmi` | `(+41/-0)[2M]` | b81bfeff3dc6fe28a85215e9c995fb00fc3d93cc `clk_rk3588.c`, `cru_rk3588.h` | `SuperKali` _clk: rockchip: rk3588: raise CPU clocks through SCMI in U-Boot proper_ |
| ✅  | `mtd-spi-nor-Add-support-for-Zbit-ZB25LQ128` | `(+2/-0)[1M]` | 369721ad6b2cbc4232df4711a36bff180fd9f45f `spi-nor-ids.c` | `Ricardo Pardini` _mtd: spi-nor: Add support for Zbit ZB25LQ128_ |
| ✅  | `pxe-over-http-v0` | `(+126/-5)[2M]` | c8f262f54644d08ff42ac48217d9d575205b2ea7 `pxe.c`, `Kconfig` | `Ricardo Pardini` _pxe: support fetching PXE/extlinux files over HTTP(S)_ |
| ✅  | `pxe-over-http-v0` | `(+25/-10)[1M]` | a59c2c98bcae56f63705ec5443164cab1029ff94 `bootmeth_pxe.c` | `Ricardo Pardini` _bootstd: extlinux-pxe: fetch files over HTTP(S) when URL-based_ |
| ✅  | `pxe-over-http-v0` | `(+56/-1)[2M]` | b5a25de949f692991106b2d7a192d00add4cfef2 `pxe.rst`, `pxelinux.rst` | `Ricardo Pardini` _doc: pxe: document booting over HTTP(S)_ |
| ✅  | `pxe-over-http-v0` | `(+43/-5)[2M]` | 438597e72169fe5dc92578c3113ce7c03bdaa202 `pxe.c`, `bootmeth_pxe.c` | `Ricardo Pardini` _DEBUG: pxe-http: trace boot path (DO NOT UPSTREAM)_ |

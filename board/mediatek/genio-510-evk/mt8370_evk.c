...
static bool board_is_genio_510_evk_qspi(void)
{
	return CONFIG_IS_ENABLED(TARGET_MT8370) &&
...
void mediatek_capsule_update_board_setup(void)
{
	...
	if (board_is_genio_510_evk()) {
	...
	} else if (board_is_genio_510_evk_qspi()) {
		efi_guid_t image_type_guid = GENIO_510_EVK_QSPI_FIT_IMAGE_GUID;
		efi_guid_t uboot_image_type_guid = GENIO_510_EVK_QSPI_FIP_IMAGE_GUID;
		efi_guid_t bl2_image_type_guid = GENIO_510_EVK_QSPI_BL2_IMAGE_GUID;
		efi_guid_t fw_image_type_guid = GENIO_510_EVK_QSPI_FW_IMAGE_GUID;
		efi_guid_t env_image_type_guid = GENIO_510_EVK_QSPI_ENV_IMAGE_GUID;
		...
		fw_images[0].fw_name = u"GENIO-510-EVK-QSPI-FIT";
		fw_images[1].fw_name = u"GENIO-510-EVK-QSPI-FIP";
...
static struct splash_location genio_510_evk_spi_splash_locations[] = {
	{
		.name = "sf",
...
{
	return splash_source_load(genio_510_evk_spi_splash_locations,
				  ARRAY_SIZE(genio_510_evk_spi_splash_locations));
}
#endif
